...
<input type="hidden" name="itemType" id="itemType" value="video-trash">
@parent
  <h3>  {{ ('Liste des videos en corbeille') }}</h3> @endsection 
  <a href="{{ route('videos.create') }}">Nouveau</a> 
  @include('video.videos.administrator.filterFields')
  <div id='tableContainer'>
   @include('video.videos.administrator.searchAndSort',['actions'=>$actions]) 
</div>
@section('sidebar')
