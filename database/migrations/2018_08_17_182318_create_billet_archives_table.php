...
class CreateBilletArchivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('billet_archives', function (Blueprint $table) {
            ...
            $table->index(['published','start_publication_at','stop_publication_at'],'billet_archives_publication_time');
    ...
    {
        Schema::dropIfExists('billet_archives');
    }
}
